...
<div id="PluginFacebook" style="display: none;">
    ...
    <div id="wizard" class="swMain">
        ...
        <h2 class="StepTitle">{$aLang.step} 2: {$aLang.page}</h2>
            ...
            <p id="login-button">{$aLang.page_list_will_load_automaticly}: <fb:login-button scope="publish_stream,offline_access,manage_pages,user_groups,read_insights" size="medium" onlogin="refreshPages()">Connect</fb:login-button></p>
